jQuery(document).ready(function($){
  ...
  if (mapElement && (window.google !== undefined) ) {
    ...
    */
    ...
    var campusMarker = {
      //url: '/sites/all/themes/jjamerson_lc/images/icons/dot-120x120-gray.png',
    ...
    var campusMarkerHighlight = {
      /*url: '/sites/all/themes/jjamerson_lc/images/icons/dot-120x120-red.png',
      size: new google.maps.Size(120, 120),
      scaledSize: new google.maps.Size(18,18),
      origin: new google.maps.Point(0, 0),
    ...
    var borMarker = {
      url: '/sites/all/themes/jjamerson_lc/images/icons/dot-100x100-gray.png',
    ...
    var borMarkerHighlight = {
      url: '/sites/all/themes/jjamerson_lc/images/icons/dot-100x100-red.png',
      size: new google.maps.Size(100, 100),
      scaledSize: new google.maps.Size(12,12),
      origin: new google.maps.Point(0, 0),
      anchor: new google.maps.Point(4,4)
